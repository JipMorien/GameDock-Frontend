...
<template>
  <div class="min-h-screen">
              ...
              <div class="bg-black rounded aspect-video flex items-center justify-center relative overflow-hidden">
                ...
                <div v-if="!isPlaying" class="text-center p-8">
                  <UIcon
                      ...
                      class="size-20 text-[var(--arcade-neon-cyan)] mb-4 mx-auto"
                  />

                  <h3 class="font-pixel text-lg text-[var(--arcade-neon-pink)] mb-2">
                    GAME CANVAS
                  </h3>

                  <p class="font-retro text-xl text-muted mb-6">
                    Your WebGL game will load here
                  </p>
                ...
                >
                  ...
                  <!-- Fullscreen Button -->
                  <button
                      class="absolute top-2 right-2 z-10 px-3 py-2 rounded bg-black/70 text-[var(--arcade-neon-cyan)] border border-[var(--arcade-neon-cyan)] font-pixel text-xs hover:bg-[var(--arcade-neon-cyan)] hover:text-black transition"
          ...
          <div class="order-1 lg:order-2 text-center lg:text-left">
            ...
            <div class="grid grid-cols-2 gap-4 max-w-sm mx-auto lg:mx-0">
              <div class="stat-card rounded-lg p-4 text-center">
                <p class="font-pixel text-xs text-[var(--arcade-neon-pink)] mb-1">
                  HIGH SCORE
                </p>

                <p class="font-retro text-2xl text-white">
                  {{ playerStats.highScore.toLocaleString() }}
                </p>
              </div>

              <div class="stat-card rounded-lg p-4 text-center">
                <p class="font-pixel text-xs text-[var(--arcade-neon-cyan)] mb-1">
                  RANK
                </p>
              ...
              <div class="stat-card rounded-lg p-4 text-center">
                <p class="font-pixel text-xs text-muted mb-1">
                  GAMES
                </p>
    ...
    <section class="py-12 border-t border-[var(--arcade-neon-cyan)]/10">
      <UContainer>
        <h2 class="font-pixel text-lg text-[var(--arcade-neon-pink)] mb-6 text-center">
          RECENT GAMES
        </h2>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          >
            <div>
              <p class="font-retro text-xl text-white">
